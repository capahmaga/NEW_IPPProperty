...
Public Class docLeaseProposal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IPPProperty.docLeaseProposal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CacheddocLeaseProposal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As docLeaseProposal = New docLeaseProposal()
        rpt.Site = Me.Site
        Return rpt
    End Function
